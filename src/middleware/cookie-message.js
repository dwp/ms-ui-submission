...
import setConsentCookie from '../../app/utils/set-consent-cookie.js';

// eslint-disable-next-line max-len
export default (app, mountUrl, proxyMountUrl, consentCookieName, cookiePolicy, cookieConsent, useTLS) => {
